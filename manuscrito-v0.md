...
5. **Campo 11 da CP** — opinião do parecer: marcar **"Eu acho que deve ser incorporada"** com primeira linha condicional no campo 12 (texto pronto em `SUBMISSAO-CP73.md`); "não tenho opinião formada" é defensável mas vira ruído na tabulação; "não deve" não é o que a análise diz. Decisão do primeiro autor.
...
1. Você tem o dossiê da SBC (PICO textual, justificativa do R$ 550, população, protocolo)? O relatório preliminar transcreve o PICO do demandante como "pacientes com suspeita de DAC estável", comparadores "angiografia invasiva; testes funcionais", e registra que o R$ 550 foi "estipulado diretamente pelo demandante" (Ofício 91/2026); não há, no relatório, protocolo de estratificação proposto pelo dossiê — mas se o dossiê o contempla, a tese muda de "alinhar" para "explicitar".
